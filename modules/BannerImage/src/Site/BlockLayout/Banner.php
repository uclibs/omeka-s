<?php
namespace BannerImage\Site\BlockLayout;
...
use BannerImage\Form\BannerBlockForm;

class Banner extends AbstractBlockLayout
{
	/**
	...
	public function form(PhpRenderer $view, SiteRepresentation $site,
		...
		$form = $this->formElementManager->get(BannerBlockForm::class);
		$data = $block
		...
		$form->setData([
			...
			'o:block[__blockIndex__][o:data][altText]' => $data['altText'],
			'o:block[__blockIndex__][o:data][textStyle]' => $data['textStyle'],
	...
	public function render(PhpRenderer $view, SitePageBlockRepresentation $block)
	{
		...
		return $view->partial('common/block-layout/simple-banner', [
			...
			'urls' => $urls,
			'altText' => $block->dataValue('altText'),
			'textStyle' => $block->dataValue('textStyle'),
