...
(function() {
    ...
    CKEDITOR.plugins.add( 'footnotes', {
        ...
        init: function(editor) {
            ...
            let pathFootnotes = this.path.split(/\//).slice(0, this.path.split(/\//).length - 7).join('/') + '/modules/BlockPlus/asset/vendor/ckeditor-footnotes/';
        ...
        generateFootnoteId: function() {
            var id = 'f-' + Math.random().toString(36).substr(2, 6);
