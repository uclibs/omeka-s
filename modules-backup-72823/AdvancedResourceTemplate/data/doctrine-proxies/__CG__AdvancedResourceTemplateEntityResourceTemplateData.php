 ...
 */
class ResourceTemplateData extends \AdvancedResourceTemplate\Entity\ResourceTemplateData implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'resourceTemplate', 'data'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ResourceTemplateData $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setResourceTemplate(\Omeka\Entity\ResourceTemplate $resourceTemplate)
    {
